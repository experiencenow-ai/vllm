...
def supports_trtllm_attention() -> bool:
    """
    TRTLLM attention is supported if the platform is Blackwell-family,
    ...
    # Requires Blackwell-family CUDA and NVIDIA artifactory to be accessible to download cubins
    return (
        current_platform.is_device_capability_blackwell() and has_nvidia_artifactory()
    )
