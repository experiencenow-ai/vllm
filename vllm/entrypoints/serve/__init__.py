...
def register_vllm_serve_api_routers(app: FastAPI):
    ...
    from vllm.entrypoints.serve.memory.api_router import (
        attach_router as attach_memory_router,
    )

    attach_memory_router(app)
    ...
    from vllm.entrypoints.serve.trim_memory_api import (
        attach_router as attach_trim_memory_router,
    )

    attach_trim_memory_router(app)
