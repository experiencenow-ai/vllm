...
DEFAULT_LMCACHE_ROOT="$HOME/ds4_lmcache/qwen27_bf16_pp${NNODES}_fp8kv/${DS4_NODE_ID}"
...
export VLLM_QWEN_GDN_PROFILE_WARMUP="${VLLM_QWEN_GDN_PROFILE_WARMUP:-1}"
export VLLM_DS4_QWEN_GDN_FIXED_TRITON_CONFIGS="${VLLM_DS4_QWEN_GDN_FIXED_TRITON_CONFIGS:-0}"
