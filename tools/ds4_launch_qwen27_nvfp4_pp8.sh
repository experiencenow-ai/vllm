...
export VLLM_DS4_SCHED_MAX_NEW_REQS_PER_STEP="${VLLM_DS4_SCHED_MAX_NEW_REQS_PER_STEP:-${QWEN27_SCHED_MAX_NEW_REQS_PER_STEP:-0}}"
export VLLM_DS4_FUSED_EXECUTE_SAMPLE="${VLLM_DS4_FUSED_EXECUTE_SAMPLE:-${QWEN27_FUSED_EXECUTE_SAMPLE:-1}}"
...
export DS4_RAIL_TCP_PREFLIGHT_MIN_GBPS="${DS4_RAIL_TCP_PREFLIGHT_MIN_GBPS:-${DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS:-10}}"
