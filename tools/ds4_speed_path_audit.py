...
check("PP8 throughput profile uses wide request admission waves", 'DSV4_SCHED_MAX_NEW_REQS_PER_STEP:=128' in pp8 and 'DSV4_SCHED_MAX_NEW_REQS_PER_STEP:=512' in pp8)
