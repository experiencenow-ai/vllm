...
check("PP8 defaults to broad NCCL PP tensor-dict path", 'VLLM_DS4_PP_TORCH_PG_TENSOR_DICT:-1' in pp8 and 'VLLM_DS4_PP_TORCH_PAIR_GROUPS:-0' in pp8 and 'VLLM_DS4_PP_PYNCCL_TENSOR_DICT:-0' in pp8)
...
check("P2P preflight can test broad world NCCL P2P without adjacent pair groups", "torch_world" in preflight and "already-initialized world NCCL communicator" in preflight)
