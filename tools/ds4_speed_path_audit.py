...
check("PP4xTP2 launcher preflights the required TP/PP P2P links", 'DS4_NCCL_PREFLIGHT_MODE="${DS4_NCCL_PREFLIGHT_MODE:-p2p_nccl}"' in pp4)
check("PP4xTP2 launcher declares TP and PP boundary P2P pairs", "0-1;2-3;4-5;6-7;0-2;2-4;4-6;1-3;3-5;5-7" in pp4)
