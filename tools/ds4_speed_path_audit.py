...
check("PP8 throughput profile uses wide prefill token waves", 'DSV4_SCHED_MAX_NEW_PREFILL_TOKENS_PER_STEP:=131072' in pp8 and 'DSV4_SCHED_MAX_NEW_PREFILL_TOKENS_PER_STEP:=262144' in pp8)
