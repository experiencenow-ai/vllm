...
check("P2P preflight supports broad PyNCCL PP communicator probing", "DS4 NCCL P2P preflight PyNCCL pair route" in preflight and "pair_nccl_ifname=" in preflight and "pynccl_world" in preflight and "broad PyNCCL communicator" in preflight and "pynccl_communicator or PyNcclCommunicator" in preflight)
...
check("DSV4 PP8 defaults NCCL preflight to the broad PyNCCL PP send/recv path used at runtime", "DS4_NCCL_PREFLIGHT_MODE:-p2p_nccl" in pp8 and "DS4_NCCL_PREFLIGHT_P2P_METHOD:-pynccl_world" in pp8 and "pynccl_world" in preflight and "broad PyNCCL communicator" in preflight and "DS4_NCCL_PREFLIGHT_P2P_SKIP_WORLD_ALLREDUCE:-1" in pp8 and "DS4_NCCL_PREFLIGHT_P2P_STRIPES" in pp8 and "DS4_NCCL_PREFLIGHT_P2P_CREDIT" in pp8 and "DS4_NCCL_PREFLIGHT_P2P_PAIRS" in pp8)
