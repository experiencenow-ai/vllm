...
check("200G guard keeps multi-node Gloo off loopback", "ds4_200g_resolve_gloo_ifname" in guard and "ds4_200g_find_management_ifname" in guard and "multi-node Gloo control cannot bind to lo" in guard and "DS4_200G_EFFECTIVE_GLOO_IFNAME" in guard)
