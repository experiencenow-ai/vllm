...
check("DSV4 PP8 rail TCP default fails below 40 Gbit/s and warns below old floor", "DS4_RAIL_TCP_PREFLIGHT_MIN_GBIT_S:-40" in pp8 and "DS4_RAIL_TCP_PREFLIGHT_WARN_GBIT_S:-64" in pp8)
...
check("DSV4 PP4xTP2 relaxes NCCL P2P fail floor but keeps warning floor", 'DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS="${DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS:-5}"' in pp4 and "DS4_NCCL_PREFLIGHT_WARN_P2P_GBPS" in pp4 and "WARNING: DS4 NCCL P2P preflight below warning threshold" in preflight)
