...
check("NCCL collective hard floor is temporarily relaxed to 10 Gbit/s", "DS4_NCCL_PREFLIGHT_MIN_BUSBW_GBPS:-1.25" in guard)
...
check("DSV4 PP4xTP2 relaxes NCCL P2P fail floor but keeps warning floor", 'DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS="${DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS:-1.25}"' in pp4 and "DS4_NCCL_PREFLIGHT_WARN_P2P_GBPS" in pp4 and "WARNING: DS4 NCCL P2P preflight below warning threshold" in preflight)
