...
check("PP8 defaults to broad NCCL PP tensor-dict path", 'VLLM_DS4_PP_TORCH_PG_TENSOR_DICT:-1' in pp8 and 'VLLM_DS4_PP_TORCH_PAIR_GROUPS:-0' in pp8 and 'VLLM_DS4_PP_TORCH_GROUP_WARMUP:-1' in pp8 and 'VLLM_DS4_PP_PYNCCL_TENSOR_DICT:-0' in pp8)
