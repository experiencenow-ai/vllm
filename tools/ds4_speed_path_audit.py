...
check("parallel_state makes payload waits stream-ordered instead of CPU synchronized", "_Ds4CudaStreamHandle" in ps and "torch.cuda.current_stream().wait_event(self._event)" in ps)
