...
checks = [
    ...
    (
        "DeepSeek V4 CUTLASS MXFP4 converter handles DSV4 weight and scale layout",
        "DSV4 loading gives contiguous [w1/gate, w3/up]" in mxfp4
        and "Mxfp4MoeBackend.FLASHINFER_CUTLASS_MXFP4_MXFP8" in mxfp4
        and "DS4 DSV4 live FlashInfer CUTLASS MXFP4/MXFP8 weight scales: raw"
        in mxfp4,
    ),
    (
    ...
    (
        ...
        and "DEFAULT_LMCACHE_ROOT=\"$HOME/ds4_lmcache/qwen27_bf16_pp${NNODES}_fp8kv/${DS4_NODE_ID}\"" in qwen_pp8,
    ),
    (
    ...
    (
        ...
        and "DEFAULT_LMCACHE_ROOT=\"$HOME/ds4_lmcache/qwen27_nvfp4_pp${PP_SIZE}_fp8kv/${DS4_NODE_ID}\"" in qwen_nvfp4_pp8,
    ),
    (
        ...
        and "VLLM_DS4_QWEN_GDN_FIXED_TRITON_CONFIGS=\"${VLLM_DS4_QWEN_GDN_FIXED_TRITON_CONFIGS:-0}\"" in qwen_pp8
