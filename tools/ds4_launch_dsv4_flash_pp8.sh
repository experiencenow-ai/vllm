...
export VLLM_DS4_SM12X_MQA_TOPK_TRITON="${VLLM_DS4_SM12X_MQA_TOPK_TRITON:-0}"
export VLLM_DS4_DEQUANT_GATHER_K_CUTEDSL="${VLLM_DS4_DEQUANT_GATHER_K_CUTEDSL:-0}"
export VLLM_DS4_DEQUANT_GATHER_K_CUTEDSL_MAX_ROWS="${VLLM_DS4_DEQUANT_GATHER_K_CUTEDSL_MAX_ROWS:-32}"
