...
export VLLM_DS4_PP_PYNCCL_P2P_CREDIT="${VLLM_DS4_PP_PYNCCL_P2P_CREDIT:-0}"
...
export DS4_NCCL_PREFLIGHT_P2P_METHOD="${DS4_NCCL_PREFLIGHT_P2P_METHOD:-pynccl}"
...
export DS4_NCCL_PREFLIGHT_P2P_DIRECTION="${DS4_NCCL_PREFLIGHT_P2P_DIRECTION:-bidirectional}"
