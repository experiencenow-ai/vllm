...
export DS4_NCCL_PREFLIGHT_P2P_PAIRS="${DS4_NCCL_PREFLIGHT_P2P_PAIRS:-0-1;2-3;4-5;6-7;0-2;2-4;4-6;1-3;3-5;5-7}"
export DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS="${DS4_NCCL_PREFLIGHT_MIN_P2P_GBPS:-10}"
export DS4_NCCL_PREFLIGHT_GROUPS="${DS4_NCCL_PREFLIGHT_GROUPS:-<unused>}"
if [[ "$NODE_RANK" == "0" ]]; then
