...
export VLLM_DS4_SKIP_LAST_RANK_SAMPLER_WARMUP="${VLLM_DS4_SKIP_LAST_RANK_SAMPLER_WARMUP:-1}"
...
export VLLM_DS4_SCHED_MAX_NEW_PREFILL_TOKENS_PER_STEP="${VLLM_DS4_SCHED_MAX_NEW_PREFILL_TOKENS_PER_STEP:-${DSV4_SCHED_MAX_NEW_PREFILL_TOKENS_PER_STEP:-32768}}"
...
export VLLM_DS4_TP_PROCESS_GROUP_ALL_REDUCE="${VLLM_DS4_TP_PROCESS_GROUP_ALL_REDUCE:-0}"
export VLLM_DS4_REQUIRE_DEVICE_TP_ALL_REDUCE="${VLLM_DS4_REQUIRE_DEVICE_TP_ALL_REDUCE:-1}"
